...
// @Param	body		body 	models.TipoResolucion	true		"body for TipoResolucion content"
// @Success 201 {int} models.TipoResolucion
// @Failure 400 the request contains incorrect syntax
// @router / [post]
func (c *TipoResolucionController) Post() {
	var v models.TipoResolucion
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if _, err := models.AddTipoResolucion(&v); err == nil {
...
// @Success 200 {object} models.TipoResolucion
// @Failure 404 not found resource
// @router /:id [get]
func (c *TipoResolucionController) GetOne() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v, err := models.GetTipoResolucionById(id)
	if err != nil {
		logs.Error(err)
...
func (c *TipoResolucionController) GetAll() {
	...
	l, err := models.GetAllTipoResolucion(query, fields, sortby, order, offset, limit)
	if err != nil {
		logs.Error(err)
...
func (c *TipoResolucionController) Put() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v := models.TipoResolucion{Id: id}
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if err := models.UpdateTipoResolucionById(&v); err == nil {
...
func (c *TipoResolucionController) Delete() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	if err := models.DeleteTipoResolucion(id); err == nil {
