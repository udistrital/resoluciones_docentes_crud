...
func TestGetAllDedicacion(t *testing.T) {
	Convey("Test: / - Dedicacion GetAll Endpoint", t, func() {
		r, err := http.NewRequest("GET", "/v1/dedicacion", nil)
		if err != nil {
			t.Fatal("error", err)
		}
...
func TestGetOneDedicacionById(t *testing.T) {
	Convey("Test: / - Dedicacion GetOne Endpoint", t, func() {
		r, err := http.NewRequest("GET", "/v1/dedicacion/1", nil)
		if err != nil {
			t.Fatal("error", err)
		}
		w := httptest.NewRecorder()
		...
		Convey("Status Code Should Be 404", func() {
			r, err = http.NewRequest("GET", "/v1/dedicacion/100", nil)
			w = httptest.NewRecorder()
			beego.BeeApp.Handlers.ServeHTTP(w, r)
