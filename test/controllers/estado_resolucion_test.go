...
func TestGetAllEstadoResolucion(t *testing.T) {
	Convey("Test: / - Estado Resolucion GetAll Endpoint", t, func() {
		r, err := http.NewRequest("GET", "/v1/estado_resolucion", nil)
		if err != nil {
			t.Fatal("error", err)
		}
...
func TestGetOneEstadoResolucionById(t *testing.T) {
	Convey("Test: / - Estado Resolucion GetOne Endpoint", t, func() {
		r, err := http.NewRequest("GET", "/v1/estado_resolucion/1", nil)
		if err != nil {
			t.Fatal("error", err)
		}
		w := httptest.NewRecorder()
		...
		Convey("Status Code Should Be 404", func() {
			r, err = http.NewRequest("GET", "/v1/estado_resolucion/100", nil)
			w = httptest.NewRecorder()
			beego.BeeApp.Handlers.ServeHTTP(w, r)
