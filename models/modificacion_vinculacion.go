...
func (t *ModificacionVinculacion) TableName() string {
	return "modificacion_vinculacion"
}

func init() {
	orm.RegisterModel(new(ModificacionVinculacion))
}

// AddModificacionVinculacion insert a new ModificacionVinculacion into database and returns
...
// GetModificacionVinculacionById retrieves ModificacionVinculacion by Id. Returns error if
// Id doesn't exist
func GetModificacionVinculacionById(id int) (v *ModificacionVinculacion, err error) {
	o := orm.NewOrm()
	v = &ModificacionVinculacion{Id: id}
...
// GetAllModificacionVinculacion retrieves all ModificacionVinculacion matches certain condition. Returns empty list if
// no records exist
...
// UpdateModificacionVinculacion updates ModificacionVinculacion by Id and returns error if
// the record to be updated doesn't exist
func UpdateModificacionVinculacionById(m *ModificacionVinculacion) (err error) {
	o := orm.NewOrm()
	v := ModificacionVinculacion{Id: m.Id}
...
// DeleteModificacionVinculacion deletes ModificacionVinculacion by Id and returns error if
...
func DeleteModificacionVinculacion(id int) (err error) {
	...
	if err = o.Read(&v); err == nil {
		var num int64
		if num, err = o.Delete(&ModificacionVinculacion{Id: id}); err == nil {
